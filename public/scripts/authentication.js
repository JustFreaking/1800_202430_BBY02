...
var uiConfig = {
  callbacks: {
    signInSuccessWithAuthResult: function (authResult, redirectUrl) {
      ...
      db.collection("users").doc(user.uid).get()
        ...
        .then(() => {
          // Redirect to /html/main.html after ensuring the user database entry exists
  ...
  signInSuccessUrl: "/html/main.html", // Redirect URL after sign-in (not used with signInSuccessWithAuthResult)
  signInOptions: [
